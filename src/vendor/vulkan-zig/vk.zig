...
pub const VideoDecodeH264CreateFlagsEXT = packed struct {
    _reserved_bits: Flags = 0,
    pub usingnamespace FlagsMixin(VideoDecodeH264CreateFlagsEXT);
};
pub const VideoDecodeH265CreateFlagsEXT = packed struct {
    _reserved_bits: Flags = 0,
    pub usingnamespace FlagsMixin(VideoDecodeH265CreateFlagsEXT);
};
...
pub const AccessFlags2KHR = packed struct(Flags64) {
    indirect_command_read_bit_khr: bool = false,
    ...
    pub usingnamespace FlagsMixin(AccessFlags2KHR);
};
pub const PipelineStageFlags2KHR = packed struct(Flags64) {
    top_of_pipe_bit_khr: bool = false,
    ...
    _reserved_bit_62: bool = false,
    _reserved_bit_63: bool = false,
    pub usingnamespace FlagsMixin(PipelineStageFlags2KHR);
};
pub const SubmitFlagsKHR = packed struct(Flags) {
    protected_bit_khr: bool = false,
    _reserved_bit_1: bool = false,
    _reserved_bit_2: bool = false,
    _reserved_bit_3: bool = false,
    ...
    _reserved_bit_30: bool = false,
    _reserved_bit_31: bool = false,
    pub usingnamespace FlagsMixin(SubmitFlagsKHR);
};
pub const EventCreateFlags = packed struct(Flags) {
    device_only_bit_khr: bool = false,
    _reserved_bit_1: bool = false,
    _reserved_bit_2: bool = false,
    _reserved_bit_3: bool = false,
    _reserved_bit_4: bool = false,
...
pub const VideoCapabilitiesFlagsKHR = packed struct(Flags) {
    ...
    _reserved_bit_30: bool = false,
    _reserved_bit_31: bool = false,
    pub usingnamespace FlagsMixin(VideoCapabilitiesFlagsKHR);
};
...
pub const VideoCodingQualityPresetFlagsKHR = packed struct(Flags) {
    ...
    _reserved_bit_30: bool = false,
    _reserved_bit_31: bool = false,
    pub usingnamespace FlagsMixin(VideoCodingQualityPresetFlagsKHR);
};
pub const VideoDecodeH264FieldLayoutFlagsEXT = packed struct(Flags) {
    line_interlaced_plane_bit_ext: bool = false,
    ...
    _reserved_bit_30: bool = false,
    _reserved_bit_31: bool = false,
    pub usingnamespace FlagsMixin(VideoDecodeH264FieldLayoutFlagsEXT);
};
...
pub const VideoEncodeH264CapabilitiesFlagsEXT = packed struct(Flags) {
    capability_cabac_bit_ext: bool = false,
    ...
    _reserved_bit_30: bool = false,
    _reserved_bit_31: bool = false,
    pub usingnamespace FlagsMixin(VideoEncodeH264CapabilitiesFlagsEXT);
};
...
pub const VideoEncodeH264CreateFlagsEXT = packed struct(Flags) {
    ...
    _reserved_bit_30: bool = false,
    _reserved_bit_31: bool = false,
    pub usingnamespace FlagsMixin(VideoEncodeH264CreateFlagsEXT);
};
...
pub const PfnCmdCopyBuffer2KHR = *const fn (
    command_buffer: CommandBuffer,
    p_copy_buffer_info: *const CopyBufferInfo2KHR,
) callconv(vulkan_call_conv) void;
pub const PfnCmdCopyImage2KHR = *const fn (
    command_buffer: CommandBuffer,
    p_copy_image_info: *const CopyImageInfo2KHR,
) callconv(vulkan_call_conv) void;
pub const PfnCmdBlitImage2KHR = *const fn (
    command_buffer: CommandBuffer,
    p_blit_image_info: *const BlitImageInfo2KHR,
) callconv(vulkan_call_conv) void;
pub const PfnCmdCopyBufferToImage2KHR = *const fn (
    command_buffer: CommandBuffer,
    p_copy_buffer_to_image_info: *const CopyBufferToImageInfo2KHR,
) callconv(vulkan_call_conv) void;
pub const PfnCmdCopyImageToBuffer2KHR = *const fn (
    command_buffer: CommandBuffer,
    p_copy_image_to_buffer_info: *const CopyImageToBufferInfo2KHR,
) callconv(vulkan_call_conv) void;
pub const PfnCmdResolveImage2KHR = *const fn (
    command_buffer: CommandBuffer,
...
pub const PfnCmdSetEvent2KHR = *const fn (
    command_buffer: CommandBuffer,
    event: Event,
    p_dependency_info: *const DependencyInfoKHR,
) callconv(vulkan_call_conv) void;
pub const PfnCmdResetEvent2KHR = *const fn (
    command_buffer: CommandBuffer,
    event: Event,
    stage_mask: PipelineStageFlags2KHR,
) callconv(vulkan_call_conv) void;
pub const PfnCmdWaitEvents2KHR = *const fn (
    command_buffer: CommandBuffer,
    event_count: u32,
    p_events: [*]const Event,
    p_dependency_infos: [*]const DependencyInfoKHR,
) callconv(vulkan_call_conv) void;
pub const PfnCmdPipelineBarrier2KHR = *const fn (
    command_buffer: CommandBuffer,
    p_dependency_info: *const DependencyInfoKHR,
) callconv(vulkan_call_conv) void;
pub const PfnQueueSubmit2KHR = *const fn (
    queue: Queue,
    submit_count: u32,
    p_submits: [*]const SubmitInfo2KHR,
    fence: Fence,
) callconv(vulkan_call_conv) Result;
pub const PfnCmdWriteTimestamp2KHR = *const fn (
    command_buffer: CommandBuffer,
    stage: PipelineStageFlags2KHR,
    query_pool: QueryPool,
    query: u32,
